  ...
  return (
    <div id="contact" className="container pb-24">
      <h1 className="text-3xl lg:text-5xl font-bold max-w-[51rem] mx-auto text-center mb-10">
        You have a project in Your mind! Contact us now.
      </h1>
      <div className="flex flex-col md:flex-row max-w-6xl mx-auto bg-white text-white rounded-2xl">
        {/* Left Section */}
        <div className="md:w-1/3 bg-primary py-14 px-7 gap-10 md:gap-5 rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none text-center md:text-start flex justify-between flex-col">
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 text-start text-md">
                <p className=" opacity-50 text-xs uppercase">Email us</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 text-start text-md">
                <p className=" opacity-50 text-xs uppercase">Phone Number</p>
                <Link href="https://wa.me/+201004894245">+20 100 489 4245</Link>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="size-12 center p-2 bg-white/10 rounded-full">
              ...
              <div className="flex-1 text-start text-md">
                <p className=" opacity-50 text-xs uppercase">Address</p>
                <p>Eldoqi - Hadaiq Elahram</p>
              </div>
            </div>
          </div>
          <div>
